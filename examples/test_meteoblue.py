...
query_sum = [{"domain": "ERA5", "gapFillDomain": "NEMSGLOBAL",
          ...
          "codes": [
              ...
              {"code":  730, "level": "2 m above gnd", "aggregation": "sum", "gddBase": 8, "gddLimit": 30}, #GDD
          ],
}]
...
query_soil = [{
    "domain": "SOILGRIDS", "gapFillDomain": "ERA5","timeResolution": "static",
          "codes": [
              { "code": 800, "level": "aggregated", "startDepth": 0, "endDepth": 150}, #Available Water Content at Field Capacity
              { "code": 801, "level": "aggregated", "startDepth": 0, "endDepth": 150}, #Water Content at Saturation
              { "code": 802, "level": "aggregated", "startDepth": 0, "endDepth": 150}, #Water Content at Wilting Point
              {"code": 808, "level": "aggregated", "startDepth": 0, "endDepth": 150}, #Bulk Density
          ],
}]
