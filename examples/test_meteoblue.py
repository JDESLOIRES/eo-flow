...
query_sum = [{"domain": "ERA5", "gapFillDomain": "NEMSGLOBAL",
          ...
          "codes": [
              ...
              {"code":  1100, "level": "sfc", "aggregation": "sum"}, #Photosynthetic active radiation
              {"code":  191, "level": "sfc", "aggregation": "sum"}, #sunshine duration
              {"code":  730, "level": "2 m above gnd", "aggregation": "sum", "gddBase": 10, "gddLimit": 30}, #GDD
          ],
}]

query_soil = [{
    "domain": "SOILGRIDS", "gapFillDomain": "ERA5","timeResolution": "static",
          "codes": [
              { "code": 800, "level": "aggregated", "startDepth": 0, "endDepth": 7}, #Available Water Content at Field Capacity
              { "code": 801, "level": "aggregated", "startDepth": 0, "endDepth": 7}, #Water Content at Saturation
              { "code": 802, "level": "aggregated", "startDepth": 0, "endDepth": 7}, #Water Content at Wilting Point
              {"code": 808, "level": "aggregated", "startDepth": 0, "endDepth": 7}, #Bulk Density
          ],
}]
