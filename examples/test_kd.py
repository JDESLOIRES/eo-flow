...
path_experiments = (
    "/home/johann/Documents/Experiments SUBTAB/training_final_scaled_paper"
)
year = 2019
...
path_experiments = (
    "/home/johann/Documents/Experiments SUBTAB/training_final_scaled_is_paper"
)
(
    training_x_is_dyn,
    training_x_is_static,
    val_x_is_dyn,
    val_x_is_static,
    test_x_is_dyn,
    test_x_is_static,
...
ls_feat = np.load(
    os.path.join(path_experiments, "2021/fold_1/list_features_satellite_features.npy"),
    allow_pickle=True,
)

training_x_is, val_x_is, test_x_is = (
    np.concatenate([training_x_is_dyn, training_x_is_static], axis=1),
...
model_cnn.load_weights(
    "/home/johann/Documents/STUDENT_PRETRAIN/" + str(year) + "/model"
)
model_student.load_weights(
    "/home/johann/Documents/TEACHER_PRETRAIN/" + str(year) + "/model"
)
