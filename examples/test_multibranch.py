...
training_s1_x = np.load(os.path.join(path_experiments, 'training_x_satellite_features.npy'))
...
training_s2_x = np.load(os.path.join(path_experiments, 'training_x_weather_features.npy'))
...
training_s3_x = np.load(os.path.join(path_experiments, 'training_x_static_features.npy'))
...
shapes = [list((training_s1_x.shape[0], training_s1_x.shape[1], 1))
