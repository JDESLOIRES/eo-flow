...
(
    ...
    val_orig_y,
    test_orig_y,
) = load_gdd_data(path_training=path_experiments, group=str(year))

training_x_orig_rts, val_orig_x_orig_rts, test_orig_x_orig_rts = (
    reshape_array(training_x_orig_ts),
...
(
    ...
    val_is_y,
    test_is_y,
) = load_gdd_data(path_training=path_experiments, group="2020_IS")

training_x_is_rts, val_is_x_is_rts, test_is_x_is_rts = (
    reshape_array(training_x_is_ts[:, :-2], 7),
